...
[![Join the chat at https://gitter.im/Laverna/laverna](https://badges.gitter.im/daed/laverna.svg)](https://gitter.im/Laverna/laverna?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)

[![Build Status](https://travis-ci.org/daed/laverna.svg?branch=dev)](https://travis-ci.org/daed/laverna) [![devDependency Status](https://david-dm.org/daed/laverna/dev-status.svg)](https://david-dm.org/daed/laverna#info=devDependencies) [![Code Climate](https://codeclimate.com/github/daed/laverna/badges/gpa.svg)](https://codeclimate.com/github/daed/laverna)
